...
# Given parameters
epsilons = [0.3141, 0.45, 0.55, 0.61]
...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.3141', 'Epsilon = 0.45', 'Epsilon = 0.55', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
