...
\author{TEJAVATH KUSHAL\\EE23BTECH11060}
\date{}
...
Hence, the un-normalized {\em stopband} frequencies are $F_{s1} = 7.6 + 0.3 = 7.9$ kHz and $F	{s2} = 6.4 - 0.3 = 6.1$ kHz.  The corresponding normalized frequencies are $\omega{s1} = 0.329 \pi$  and $\omega_{s2} =  0.254 \pi$.
\end{enumerate}
...
\begin{lstlisting}
https://github.com/kushal2310/FILTER_DESIGN/blob/main/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/kushal2310/FILTER_DESIGN/blob/main/codes/sk_gen.c
\end{lstlisting}
